class User < ActiveRecord::Base
  ...
  has_many :follower_association, foreign_key: :following_id, class_name: 'Follow'
  has_many :followers, through: :follower_association, source: :follower

  has_many :following_association, foreign_key: :follower_id, class_name: 'Follow'
  has_many :followees, through: :following_association, source: :following

  has_many :tweets,foreign_key: :user_id, class_name: 'Tweet', dependent: :destroy
  has_many :tweets_all, through: :tweets, source: :user
